...
to_addr_list = get_valid_email("Enter the recipient email address(es) separated by commas: ").split(',')
cc_addr_list = input("Enter the CC email address(es) separated by commas: ").split(',')
